    ...
    >
      ...
      <div className="max-w-[1150px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-8 lg:gap-8 max-w-5xl mx-auto">
          ...
          <div 
            className="w-full lg:w-[45%] order-2 lg:order-1 axe-card p-6 sm:p-8 flex flex-col justify-between text-left border border-[#D4A43E]/30 relative rounded-2xl"
            style={{
          ...
          <div 
            className="w-full lg:w-[55%] order-1 lg:order-2 rounded-2xl p-7 sm:p-9 flex flex-col justify-between text-left relative z-10 border-2 border-[#D4A43E] shadow-[0_20px_50px_rgba(129,0,24,0.4),0_0_30px_rgba(212,164,62,0.3)] transform lg:-translate-y-2"
            style={{
